...
// console.log(divisão()) // undefined


//As funções ajudam muito no desenvolvimento de um código, pois colaboram para
// a separação de trechos de código com funções específicas, tornando-o menor 
// e mais legível, o JavaScript nos oferece algumas funções prontas, como é o 
...
//Para ver mais funções matemáticas, basta acessar:
